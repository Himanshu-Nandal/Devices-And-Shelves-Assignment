...
public class DeviceController {
    ...
    public ResponseEntity<Map<String, Object>> createDevice(@RequestBody Device device) {
        logger.info("Controller: Creating device: {}", device.getDeviceName());
    ...
    public ResponseEntity<Map<String, Object>> getDeviceById(@PathVariable String deviceId) {
        logger.info("Controller: Fetching device with ID: {}", deviceId);
    ...
    public ResponseEntity<Map<String, Object>> updateDevice(@PathVariable String deviceId, @RequestBody Device device) {
        logger.info("Controller: Updating device with ID: {}", deviceId);
    ...
    public ResponseEntity<Map<String, Object>> deleteDevice(@PathVariable String deviceId) {
        logger.info("Controller: Soft deleting device with ID: {}", deviceId);
    ...
    public ResponseEntity<Map<String, Object>> getDeviceByName(@PathVariable String deviceName) {
        logger.info("Controller: Fetching device with Name: {}", deviceName);
